...
function Violators() {
    ...
    return (
      <div className="flex gap-1 overflow-x-auto">
        {evidenceUrls.slice(0, 3).map((url, idx) => (
          <div key={idx} className="w-16 h-16 bg-gray-100 rounded-lg border border-gray-300 overflow-hidden flex items-center justify-center flex-shrink-0">
        ...
        {evidenceUrls.length > 3 && (
          <div className="w-16 h-16 bg-gray-100 rounded-lg border border-gray-300 flex items-center justify-center flex-shrink-0">
  ...
  const renderDetailView = () => {
    ...
    const caseNumber = getCaseNumber(selectedComplaint.id);
    const countryCode = selectedComplaint.country;
          ...
          <div className="bg-white/95 rounded-2xl shadow-lg p-6 border border-blue-100 backdrop-blur-sm">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <h1 className="text-2xl font-bold text-blue-950 text-center flex-1">
                Human Rights Violation Case #{caseNumber}
              </h1>
            </div>

            {/* Main information - Single column layout */}
        ...
        <div className="bg-white/95 rounded-2xl shadow-lg p-6 mb-8 border border-blue-100 backdrop-blur-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors shadow-md"
            >
                      ...
                      <div className="p-4 space-y-3">
                        ...
                        {complaint.victims_info && (
                          <div className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">{complaint.victims_info}</p>
                            </div>
                          </div>
                        )}
                        ...
                        {complaint.violation_action && (
                          <div>
                            ...
                            <p className="text-sm text-gray-600">{complaint.violation_action}</p>
                          </div>
                        )}
